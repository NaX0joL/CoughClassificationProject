...
class MetadataExcluder():
    ...
    def _filter_based_on_Audio_exists(self, metadata:dict|None) -> dict|None:
        if metadata is None:
            return None
    ...
    def _filter_based_on_isInfectious(self, metadata:dict|None) -> dict|None:
        if metadata is None:
            return None
    ...
    def _filter_based_on_Usability(self, metadata:dict|None) -> dict|None:
        if metadata is None:
            return None
