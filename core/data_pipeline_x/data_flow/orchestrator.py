"""Lazy data-flow orchestration for fold-specific data modules."""
...
class DataFlowOrchestrator:
    ...
    def init_fold_partitions(self) -> None:
        self.source_records = self.source_reader.get_source_records()
        self.fold_partitions = self.partitioner.partition(self.source_records)
        return
